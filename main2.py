...
#     # draw the enemies
#     cv.circle(img=img, center=(red_x, red_y), radius=40, color=c.red, thickness=10)
    
# def green(img):
#     global score, green_x, green_y
        ...
        for hand in results.multi_hand_landmarks:
            for Id, lm in enumerate(hand.landmark):
                ...
                if Id == 8:
                    ...
                    if pixelLm[0] == green_x or pixelLm[0] == green_x + 10 or pixelLm[0] == green_x - 10 or pixelLm[1] == green_y or  pixelLm[1] == green_y-10 or  pixelLm[1] == green_y+10:
                        print("Gotcha!")
